		...
		<div className='news-slide'>
			<div className="news-slide-text">
				...
				<div className="text-right mt-3">
					<a href="#" className="news-slide-link"> <i className="fas fa-arrow-right mr-2"></i>Read more</a>
				</div>
			</div>
			<div className="news-slide-img" style={{backgroundImage:`url(${el.img})`}}>
				{/* <img src={el.img} alt="News" className="w-100"/> */}
			</div>
		</div>
